...
fun Vector3.toLatLng(): LatLong {
    // phi
    val lat = acos(y / Sphere.Companion.RADIUS)
...
fun LatLong.toVector3(): Vector3 {
    ...
    val x = -Sphere.Companion.RADIUS * cos(phi) * sin(theta)
    val y = Sphere.Companion.RADIUS * sin(phi)
    val z = Sphere.Companion.RADIUS * cos(phi) * cos(theta)
