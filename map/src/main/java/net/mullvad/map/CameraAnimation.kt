...
import net.mullvad.map.internal.DISTANCE_DURATION_SCALE_FACTOR
import net.mullvad.map.internal.FAR_ANIMATION_MAX_ZOOM_MULTIPLIER
import net.mullvad.map.internal.MAX_ANIMATION_MILLIS
import net.mullvad.map.internal.MAX_MULTIPLIER_PEAK_TIMING
import net.mullvad.map.internal.MIN_ANIMATION_MILLIS
import net.mullvad.map.internal.SHORT_ANIMATION_CUTOFF_MILLIS
