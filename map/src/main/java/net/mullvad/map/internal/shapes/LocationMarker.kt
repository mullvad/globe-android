package net.mullvad.map.internal.shapes
...
import net.mullvad.map.internal.COLOR_COMPONENT_SIZE
import net.mullvad.map.internal.VERTEX_COMPONENT_SIZE
import net.mullvad.map.internal.initShaderProgram
import net.mullvad.map.internal.toFloatArray
import net.mullvad.map.data.LatLong
import net.mullvad.map.internal.initGLArrayBuffer
...
internal class LocationMarker(val colors: LocationMarkerColors) {
    ...
    init {
        ...
        colorBuffer = initGLArrayBuffer(colorFloatBuffer)
