package net.mullvad.map.internal
...
import net.mullvad.map.data.toRadians
import net.mullvad.map.internal.shapes.Globe
import net.mullvad.map.internal.shapes.LocationMarker
import javax.microedition.khronos.egl.EGLConfig
import javax.microedition.khronos.opengles.GL10
import kotlin.math.pow
import kotlin.math.sqrt
import kotlin.math.tan
import net.mullvad.map.data.Ray
import net.mullvad.map.data.Sphere
import net.mullvad.map.data.Vector3
import net.mullvad.map.data.rotateAroundX
import net.mullvad.map.data.rotateAroundY
import net.mullvad.map.data.toVector3
...
internal class MapGLRenderer(private val resources: Resources) : GLSurfaceView.Renderer {
    ...
    internal var viewState: MapViewState = MapViewState.default()
        set(value) {
            field = value
